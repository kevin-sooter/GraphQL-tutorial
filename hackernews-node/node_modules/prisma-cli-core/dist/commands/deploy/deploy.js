...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var force, interactive, envFile, dryRun, noMigrate, serviceName, stage, workspace, cluster, endpointDialog, results, _a, projectNew;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 18:
                        ...
                        projectNew = true;
                        _b.label = 19;
                    case 19: return [4 /*yield*/, this.deploy(stage, serviceName, cluster, cluster.name, force, dryRun, projectNew, workspace, noMigrate)];
                    case 20:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    Deploy.prototype.deploy = function (stageName, serviceName, cluster, completeClusterName, force, dryRun, projectNew, workspace, noMigrate) {
        return __awaiter(this, void 0, void 0, function () {
            var before, b, verb, migrationResult, done, revision, migration, hooks, _i, hooks_1, hook, splittedHook, isPackaged, spawnPath, child, stderr, stdout, status_1, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        before = Date.now();
                    ...
                    case 6:
                        ...
                        if (!migrationResult.migration) return [3 /*break*/, 10];
                        if (!(this.definition.definition.seed &&
                            !this.flags['no-seed'] &&
                            projectNew)) return [3 /*break*/, 8];
                        this.printHooks();
    ...
    Deploy.prototype.printResult = function (payload, force, dryRun) {
        ...
        if (steps.length > 0) {
            this.out.log('\n' + chalk_1.default.bold(dryRun ? 'Potential changees:' : 'Changes:'));
