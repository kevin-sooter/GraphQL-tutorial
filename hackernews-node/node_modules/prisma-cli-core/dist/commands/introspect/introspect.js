...
var IntrospectCommand = /** @class */ (function (_super) {
    ...
    IntrospectCommand.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connectorData, before, _a, newDatamodelSdl, numTables, referenceDatamodelExists, fileName, andDatamodelText;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getConnectorWithDatabase()
                        /**
                    ...
                    case 2:
                        ...
                        if (!(this.definition.definition && !this.definition.definition.datamodel)) return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        sdl = _b;
                        renderer = prisma_datamodel_1.DefaultRenderer.create(introspection.databaseType, this.flags.prototype);
    ...
    IntrospectCommand.prototype.writeDatamodel = function (renderedSdl) {
        var prototypeFileName = this.flags.prototype ? '-prototype' : '';
        var fileName = "datamodel" + prototypeFileName + "-" + new Date().getTime() + ".prisma";
