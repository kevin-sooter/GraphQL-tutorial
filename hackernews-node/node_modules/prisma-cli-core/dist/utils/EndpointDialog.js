...
var EndpointDialog = /** @class */ (function () {
    function EndpointDialog(_a) {
        var out = _a.out, client = _a.client, env = _a.env, config = _a.config, definition = _a.definition, shouldAskForGenerator = _a.shouldAskForGenerator, _b = _a.prototype, prototype = _b === void 0 ? false : _b;
        var _this = this;
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        switch (_c) {
                            ...
                            case 'Demo server': return [3 /*break*/, 25];
                        }
                        return [3 /*break*/, 27];
                    ...
                    case 21:
                        isdl = _h.sent();
                        renderer = prisma_datamodel_1.DefaultRenderer.create(databaseType, this.prototype);
