...
describe('parseEndpoint', function () {
    ...
    test('work for minimal docker url', function () {
        expect(parseEndpoint_1.parseEndpoint('http://prisma:4466')).toMatchSnapshot();
    });
    test('local behind a proxy', function () {
        ...
        expect(parseEndpoint_1.parseEndpoint('http://local.dev')).toMatchSnapshot();
    });
    ...
    test('custom hosted url in internet', function () {
        expect(parseEndpoint_1.parseEndpoint('https://api-prisma.divyendusingh.com/zebra-4069/dev')).toMatchSnapshot();
    });
    test('custom hosted url as ip in internet', function () {
        expect(parseEndpoint_1.parseEndpoint('http://13.228.39.83:4466')).toMatchSnapshot();
    });
});
