...
var RelationalIntrospectionResult = /** @class */ (function (_super) {
    ...
    RelationalIntrospectionResult.prototype.hideUniqueIndices = function (types) {
        var e_18, _a, e_19, _b;
        try {
            for (var types_11 = __values(types), types_11_1 = types_11.next(); !types_11_1.done; types_11_1 = types_11.next()) {
                var type = types_11_1.value;
            ...
            try {
                if (types_11_1 && !types_11_1.done && (_a = types_11.return)) _a.call(types_11);
            }
    ...
    RelationalIntrospectionResult.prototype.inferDefaultValues = function (types) {
        var e_20, _a, e_21, _b;
        try {
            for (var types_12 = __values(types), types_12_1 = types_12.next(); !types_12_1.done; types_12_1 = types_12.next()) {
                var type = types_12_1.value;
                try {
                    for (var _c = __values(type.fields), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var field = _d.value;
            ...
            try {
                if (types_12_1 && !types_12_1.done && (_a = types_12.return)) _a.call(types_12);
            }
    ...
    RelationalIntrospectionResult.prototype.inferField = function (field) {
        ...
        var gqlField = {
            ...
            type: field.type,
            isId: false,
            idStrategy: field.isAutoIncrement ? prisma_datamodel_1.IdStrategy.Auto : prisma_datamodel_1.IdStrategy.None,
            associatedSequence: null,
            relatedField: null,
            relationName: null,
