...
var Client = /** @class */ (function () {
    ...
    Client.prototype.initClusterClient = function (cluster, serviceName, stageName, workspaceSlug) {
        return __awaiter(this, void 0, void 0, function () {
            var token, authenticationPayload, serviceCreatedInCloud, agent, e_1, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(!cluster.local && authenticationPayload.isAuthenticated && workspaceSlug)) return [3 /*break*/, 4];
                    ...
                    case 5:
                        e_1 = _a.sent();
                        if (!e_1.message.includes('Not authorized')) return [3 /*break*/, 8];
    ...
    Client.prototype.deploy = function (name, stage, types, dryRun, subscriptions, secrets, force, noMigration) {
        return __awaiter(this, void 0, void 0, function () {
            var oldMutation, introspectionResult, hasStepsApi, hasRelationManifestationApi, steps, noMigrationInput, newMutation, deploy, e_4, deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        e_4 = _a.sent();
                        if (!e_4.message.includes("Field 'force' is not defined in the input type")) return [3 /*break*/, 6];
